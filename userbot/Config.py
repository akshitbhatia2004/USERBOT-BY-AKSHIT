...
if ENV:
    ...
    class Config(object):
        ...
        # emoji to be displayed  in help .akshit
        ...
        ALIVE_PIC = (
            ...
            or "https://telegra.ph/file/f6f6f8006a1861383c566.jpg"
        )
        PM_PIC = (
        ...
        ALIVE_MSG = os.environ.get("ALIVE_MSG", None) or "彡aͥksͣhͫᎥτ彡 Is Online"
        PM_MSG = os.environ.get("PM_MSG", None)
        INSTANT_BLOCK = os.environ.get("INSTANT_BLOCK", "DISABLE")
        YOUR_GROUP = os.environ.get("YOUR_GROUP", "@AKSHIT_USERBOT")
        YOUR_CHANNEL = os.environ.get("YOUR_CHANNEL", "@OFFICIAL_USERBOTBYAKSHIT.")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/akshitbhatia2004/USERBOTBYAKSHIT"
        )
        APP_ID = os.environ.get("APP_ID", None)
        API_HASH = os.environ.get("API_HASH", None)
        AKSHIT_STRING = os.environ.get("AKSHIT_STRING", None)
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "AKSHITBOT")
        ...
        # number of rows of buttons to be displayed in .akshit command
        ...
        # number of colums of buttons to be displayed in .akshit command
