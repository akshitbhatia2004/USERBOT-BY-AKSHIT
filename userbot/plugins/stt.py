...
async def _(event):
    ...
    AKSHITevent = await edit_or_reply(event, "Downloading to my local, for analysis  🙇")
    if event.reply_to_msg_id:
        ...
        if (
            ...
            await AKSHITevent.edit("Starting analysis, using IBM WatSon Speech To Text")
            headers = {
            ...
            if "results" in r:
                ...
                await AKSHITevent.edit(string_to_show)
            else:
                await AKSHITevent.edit(r["error"])
