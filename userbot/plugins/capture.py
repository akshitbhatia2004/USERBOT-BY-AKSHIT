...
async def _(event):
    ...
    if Config.GOOGLE_CHROME_BIN is None:
        ...
        return
    AKSHIT = await eor(event, "Processing ...weit")
    ...
    try:
        ...
        with io.BytesIO(im_png) as out_file:
            out_file.name = "AKSHITBOT.ScreenCapture.PNG"
            await bot.send_file(
                event.chat_id,
                out_file,
                caption=input_str,
        ...
        await eod(AKSHIT, traceback.format_exc())
...
CmdHelp("capture").add_command(
    ...
    "screenshot https://github.com/akshitbhatia2004/USERBOTBYAKSHIT",
