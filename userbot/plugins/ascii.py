...
async def _(event):
    ...
    if reply_message.sender.bot:
        ...
        return
    AKSHIT = await edit_or_reply(event, "Wait making ASCII...🤓🔥🔥")
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await AKSHIT.edit("`Please unblock @asciiart_bot and try again`")
            return
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await AKSHIT.edit("Please unblock @Lines50Bot and try again")
            return
        await AKSHIT.delete()
        await event.client.send_file(
            event.chat_id,
