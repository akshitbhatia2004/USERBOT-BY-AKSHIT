...
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await edit_or_reply(event, "`Testing AKSHITBOT`")
        ...
        await asyncio.sleep(2)
        await edit_or_reply(event, "**SAVING OUTPUT TO AKSHITBOT LOCAL DATABASE**")
        await asyncio.sleep(3.5)
        await edit_or_reply(
            event,
            "Your [AKSHITBOT](https:/t.me/AKSHIT_Userbot) is working Fine...\n       Join @AKSHIT_Userbot For Any Help......",
        )
