...
@AKSHITBOT.on(admin_cmd(pattern="sin ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="cos ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="tan ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="sec ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="cot ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="square ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@AKSHITBOT.on(admin_cmd(pattern="cube ?(.*)"))
@AKSHITBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
