...
async def ammastar(AKSHITstar):

    if AKSHITstar.fwd_from:
    ...
    await edit_or_reply(AKSHITstar, "I am A Star")
    ...
    for i in animation_ttl:
        ...
        await AKSHITstar.edit(animation_chars[i % 11])
