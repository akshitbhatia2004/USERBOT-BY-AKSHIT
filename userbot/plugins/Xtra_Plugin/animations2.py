...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](akshitbhatia2004/USERBOTBYAKSHIT)**",
        ...
        "__INFO:AKSHITBOT:Logged in as 557667062__",
        "__INFO:AKSHITBOT:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
